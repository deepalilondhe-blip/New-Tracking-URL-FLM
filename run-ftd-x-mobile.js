...
console.log('📱 Running FTD-X Campaign in iPhone 17 Pro Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPhone 17 Pro FTD-X Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'FTD_X_iPhone17Pro.zip') });
        console.log(`\n📱 Fixed Mobile Trace Report saved`);

    } catch (error) {
        console.error('❌ iPhone 17 Pro FTD-X Test failed:', error);
    } finally {
