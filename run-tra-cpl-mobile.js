...
console.log('📱 Running TRA-CPL Campaign in iPhone 17 Pro Emulation...');
console.log('📱 Fixed dropdown timing issues, updated slowMo and timeout values');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPhone 17 Pro TRA-CPL Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'TRA_CPL_iPhone17Pro_FIXED.zip') });
        console.log(`\n📱 Fixed Mobile Trace Report saved`);

    } catch (error) {
        console.error('❌ iPhone 17 Pro TRA-CPL Test failed:', error);
    } finally {
