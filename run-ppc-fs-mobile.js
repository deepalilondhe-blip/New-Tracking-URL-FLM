...
console.log('📱 Running PPC-FS Campaign in iPhone 17 Pro Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPhone 17 Pro PPC-FS Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'PPC_FS_iPhone17Pro.zip') });
        console.log(`\n📱 Fixed Mobile Trace Report saved`);

    } catch (error) {
        console.error('❌ iPhone 17 Pro PPC-FS Test failed:', error);
    } finally {
