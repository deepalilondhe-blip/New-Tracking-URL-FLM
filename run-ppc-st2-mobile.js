...
console.log('📱 Running PPC-ST2 Campaign in iPhone 17 Pro Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPhone 17 Pro PPC-ST2 Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'PPC_ST2_iPhone17Pro.zip') });
        console.log(`\n📱 Fixed Mobile Trace Report saved`);

    } catch (error) {
        console.error('❌ iPhone 17 Pro PPC-ST2 Test failed:', error);
    } finally {
