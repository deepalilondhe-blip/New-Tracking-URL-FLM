...
console.log('📋 Running PPC Campaign in iPad (Tablet) Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPad PPC Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'PPC_Tablet.zip') });
        console.log(`\n📋 Tablet Trace Report saved`);

    } catch (error) {
        console.error('❌ iPad PPC Test failed:', error);
    } finally {
