...
console.log('📋 Running FTH-X Campaign in iPad (Tablet) Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPad FTH-X Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'FTH-X_Tablet.zip') });
        console.log(`\n📋 Tablet Trace Report saved`);

    } catch (error) {
        console.error('❌ iPad FTH-X Test failed:', error);
    } finally {
