...
console.log('📱 Running PPC-CR Campaign in iPhone 17 Pro Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPhone 17 Pro PPC-CR Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'PPC_CR_iPhone17Pro.zip') });
        console.log(`\n📱 Fixed Mobile Trace Report saved`);

    } catch (error) {
        console.error('❌ iPhone 17 Pro PPC-CR Test failed:', error);
    } finally {
