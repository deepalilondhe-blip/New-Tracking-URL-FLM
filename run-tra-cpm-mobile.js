...
console.log('📱 Running TRA-CPM Campaign in iPhone 15 Pro Max Emulation...');
...
(async () => {
    ...
    try {
        ...
        console.log('✅ iPhone TRA-CPM Test completed:', result);

        await context.tracing.stop({ path: path.join(traceDir, 'TRA-CPM_Mobile.zip') });
        console.log(`\n📱 Mobile Trace Report saved`);

    } catch (error) {
        console.error('❌ iPhone TRA-CPM Test failed:', error);
    } finally {
